...
class QiUnipa2_audio(Node):
    ...
    def transcribe_audio_file(self, file_path):
        ...
        self.get_logger().warn(f"🎤 [TRANSCRIBE] Inizio: {file_path}")
        ...
        try:
            with open(file_path, 'rb') as audio_file:
                ...
                self.get_logger().warn(f"🎤 [TRANSCRIBE] Size: {file_size} bytes")
                ...
                self.get_logger().warn(f"🎤 [TRANSCRIBE OK] {transcription}")
